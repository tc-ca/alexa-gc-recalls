...
const CompletedGetVehicleYearIntentHandler = {
  ...
  async handle (handlerInput) {
    ...
    const year = new Vehicle.Year({ yearSlotValue: slotValues.year.resolved })
...
const CompletedGetVehicleYearButMakeNotProvidedIntentHandler = {
  canHandle (handlerInput) {
    return handlerInput.requestEnvelope.request.type === 'IntentRequest' &&
          handlerInput.requestEnvelope.request.intent.name === 'GetVehicleYearIntent' &&
          handlerInput.requestEnvelope.request.dialogState === 'COMPLETED' &&
    ...
    return handlerInput.responseBuilder
      .addDelegateDirective({
        ...
        slots: {
          model: {
            name: 'model',
            value: model.slotValue,
            confirmationStatus: 'NONE',
            source: 'USER'
          },
          year: {
            name: 'year',
            value: '2006', // placing value breaks Alexa and gives and error. Only works if I place null in the value property. Why???
            confirmationStatus: 'NONE',
            source: 'USER'
          },
          make: {
          ...
          multipleChoiceNoResponse: {
            name: 'multipleChoiceNoResponse',
            value: 'testx',
            confirmationStatus: 'NONE',
            source: 'USER'
          },
...
module.exports = {
  InProgress: InProgressGetVehicleYearIntentHandler,
  Completed: CompletedGetVehicleYearIntentHandler,
  CompletedNotCompleted: CompletedGetVehicleYearButMakeModelNotProvidedIntentHandler,
  CompletedNotCompletedMakeMissing: CompletedGetVehicleYearButMakeNotProvidedIntentHandler }
