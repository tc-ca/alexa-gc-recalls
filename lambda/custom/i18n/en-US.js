...
module.exports = {
  translation: {
    ...
    SPEECH_TXT_VEHICLE_RECALL_READING_INTRO: `While I'm reading you the ${PHONEMES.recall} information, at any point you can skip to the next ${PHONEMES.recall} by saying "Alexa skip". `,
    SPEECH_TXT_VEHICLE_RECALL_READING_DETAILS: `<p>On ${RECALL_DATE} there was a ${PHONEMES.recall} affecting the ${RECALL_COMPONENT}.<break time="500ms"/> ${RECALL_DETAILS}</p>`,
    SPEECH_TXT_VEHICLE_RECALL_READING_DONE: `<p>That's all the information I have for your ${VEHICLE_MAKE_MODEL_YEAR} vehicle. Do you want me to repeat the ${PHONEMES.recall} information for this vehicle?  </p>`,
