...
module.exports = {
  translation: {
    ...
    /// //// ALEXA CARDS \\\\\\
    CARD_TXT_VEHICLE_RECALLS_READING_DETAILS: `Le ${RECALL_DATE}, un rappel de sécurité affectant le système suivant: ${RECALL_COMPONENT} a été émit. ${RECALL_DETAILS}`, // I need translation (Lisa: I translated, but more context would be helpful here too - how is the date presented? does it fit into this sentence structure?)
    ...
    CARD_TXT_VEHICLE_RECALLS_FOUND_ONE: `J'ai trouvé un rappel pouvant affecter ton véhicule ${VEHICLE_SPEECH_VERSION}.`, // I need translation (Lisa: done, but would like to test in context) 
